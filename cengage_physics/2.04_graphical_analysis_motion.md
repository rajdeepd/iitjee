...
| :---: | :--- |:--- |:--- |
| 1. | For a stationary body, the $s-t$ <br> graph is a straight line, $A B$, <br> paraliel to time axis. | ![img](./images/2.04_figure6.png)| The slope of straight line $A B$ <br/>(representing instantaneous velocity) is <br/>zero.|
